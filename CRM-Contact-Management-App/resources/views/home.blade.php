...
@section('content')
    ...
    <div class="container mx-auto py-10">
        ...
        {{-- Search --}}
        <div class="mb-4 flex">
            <form action="{{ route('contact-search') }}" method="get" class="flex items-center">
                @csrf
                @method('get')
                
                <input type="text" name="search-contact" placeholder="Search contacts..." class="px-4 py-2 rounded-l border border-gray-300 text-black focus:outline-none focus:border-blue-500 transition duration-300">
